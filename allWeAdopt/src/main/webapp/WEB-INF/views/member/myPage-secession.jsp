                            ...
                            <div class="col-lg-8 col-xl-6">
                                <form action="secession" method="post" name="frm"  class="form-floating" id="add_member_form" onsubmit="return secessionValidate()">
                                    <div class=" form-floating mb-3">
                                        ...
                                        <input type="password" class="form-control" id="floatingInputValue" name="memberPw" placeholder="Enter your name..." >
                                            <label for="floatingInputValue"><span>* </span>비밀번호</label>
                                        </c:if>
                                   
                                    </div>


                                    <div class="g-recaptcha row justify-content-center mb-5" data-sitekey='6LfbI-MgAAAAAGAO7v9zg_Z68NxrIkKkTo1RwKhk'></div>

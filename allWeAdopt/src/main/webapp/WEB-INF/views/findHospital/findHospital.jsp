...
<html>
    ...
    <body class="d-flex flex-column">
		...
		<script>
		const url = 'http://openapi.seoul.go.kr:8088/58717a6e5463686f3130306d58694a4f/json/LOCALDATA_020301/1/10/';
	...
	if (navigator.geolocation) {
	    ...
	    navigator.geolocation.getCurrentPosition(function(position) {
	        ...
	        .then((myJson) =>{
	            ...
	            var markers = [];
	            const results = myJson.LOCALDATA_020301;
	            for (var i=0; i<results.length; i++){
	                ...
	                var marker = new kakao.maps.Marker({  
	                    position: new kakao.maps.LatLng(results[i][X], results[i][Y]), // 마커의 좌표
	                }); 
	                
	                // 인포윈도우를 생성합니다
	                var infowindow = new kakao.maps.InfoWindow({
	                    content : results[i]["BPLCNM"],
	                });

...
<html>
    <head>
        ...
        <link href="${contextPath}/resources/css/funding/funding-payment.css" rel="stylesheet" />
                            ...
                            <div class="paymentWrapper">
                                ...
                                <div class="rewardInfo">
                                    ...
                                    <div class="rewardRow">
                                        ...
                                        <div class="resultInfo">
                                            <span class="resultPay">200,000</span>
                                            <span>수량: 2</span>
                                        </div>
                                        <hr>
                                ...
                                <div id="information">
                                    ...
                                    <div class="parcelInfo">
                                        ...
                                        <div class="inputArea">
                                            <div class="inputName">
                                                <span>이름</span><br>
                                                <input type="text" name="inputName" placeholder="이름을 입력해주세요">
                                            </div>

                                            <div class="inputTel">
                                                <span>휴대전화</span><br>
                                                <input type="text" name="inputTel" placeholder="휴대폰번호를 입력해주세요">
                                            </div>

                                            <div class="inputTel">
                                                <span>전화번호</span><br>
                                                <input type="text" name="inputTel" placeholder="전화번호를 입력해주세요">
                                            </div>

                                            <div class="inputAddr">
                                                <span>주소</span><br>
                                                <button onclick="execDaumPostcode()" id="findPostcode">우편번호 찾기</button>
                                             <!--    <p id="addressInfo" class="badge bg-primary text-wrap">(13536)경기 성남시 분당구 판교역로 4</p> -->
                                                ...
                                                <input type="text" name="detailAddress" placeholder="상세주소를 입력해주세요">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="paymentWrapper">
                                    ...
                                    <div class="paymentMeans">
                                        <span>
                                            <input class="form-check-input" type="radio" name="payment" id="makeAdeposit"> 
                                            <label class="form-check-label" for="makeAdeposit">
                                            무통장 입금
                                            </label>
                                        </span>
                                        <span>
                                            <input class="form-check-input" type="radio" name="payment" id="simplePay">
                                            <label class="form-check-label" for="simplePay">
                                            간편 결제
                                            </label>
                                        </span>
                                        <span>
                                            <input class="form-check-input" type="radio" name="payment" id="phonePay">
                                            <label class="form-check-label" for="phonePay">
                                            핸드폰 결제
                                            </label>
                                        </span>
                                    </div>
                                ...
                                <div class="agreeWrapper">
                                    ...
                                    <br>
                                    <div><input class="form-check-input" type="checkbox"> <a href="">전체 동의하기</a> </div>
                                    <div><input class="form-check-input" type="checkbox" role="switch"> <a href="">개인정보 제3자 제공 동의</a> </div>
                                    <div><input class="form-check-input" type="checkbox" role="switch"> <a href="">책임 규정에 대한 동의</a> </div>
                                </div>
